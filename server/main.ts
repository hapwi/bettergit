...
const routes: Record<string, RouteHandler> = {
  ...
  "POST /api/github/viewer": async (body) => getGhViewer(body as Parameters<typeof getGhViewer>[0]),
  "POST /api/github/repos/list": async (body) => listGhRepos(body as Parameters<typeof listGhRepos>[0]),
  "POST /api/github/repos/clone": async (body) => cloneGhRepo(body as Parameters<typeof cloneGhRepo>[0]),
  ...
  "POST /api/git/dashboard/overview": async (body) => getDashboardOverview(body as Parameters<typeof getDashboardOverview>[0]),
  "POST /api/git/dashboard/data": async (body) => getDashboardData(body as Parameters<typeof getDashboardData>[0]),
